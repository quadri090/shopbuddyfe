...
export default function SideBar() {
  ...
  return (
    <div className="fixed md:relative left-0 top-0 z-50 h-screen md:h-auto w-10/12 md:w-[280px] md:rounded-lg bg-white p-6 shadow-[-5px_0px_60px_5px_rgba(0,0,0,0.35)]">
