...
function MenuItemsContainer(props) {
  return (
    <div className="absolute flex w-48 flex-col gap-1 rounded-lg bg-white px-6 py-6 text-left text-base text-zinc-500 shadow-2xl transition-transform duration-1000 ease-in ">
      {props.children}
    </div>
  );
}
...
function CategoryContainer(props) {
  return (
    <div className="w-11/12 mt-4 grid grid-cols-4 gap-4 p-6 text-left left-[4.5%] absolute rounded-lg bg-white text-zinc-500 shadow-2xl">
      {props.children}
    </div>
  )
}
...
export default function Menu() {
  ...
  return (
      <div className="hidden md:flex items-center justify-center gap-10 text-zinc-700">
        <div
        ...
        <div
          ...
          onMouseOut={() => setMouseHover(null)}
        >
          <MenuCard header="Categories" >
          </MenuCard>
          {mouseHover === 1 && (
        <CategoryContainer>
          <CategoryItems header="Electronics" imgSrc="https://e-commerce-smoky-eight-80.vercel.app/img/electronics-banner-1.jpg">
          ...
          <CategoryItems header="Men's" imgSrc="https://e-commerce-smoky-eight-80.vercel.app/img/mens-banner.jpg">
            <MenuItems description="Desktop"/>
            <MenuItems description="Laptop"/>
            <MenuItems description="Camera"/>
            <MenuItems description="Tablet"/>
          ...
          <CategoryItems header="Women's" imgSrc="https://e-commerce-smoky-eight-80.vercel.app/img/womens-banner.jpg">
            <MenuItems description="Desktop"/>
            <MenuItems description="Laptop"/>
            <MenuItems description="Camera"/>
            <MenuItems description="Tablet"/>
          ...
          <CategoryItems header="Electronics" imgSrc="https://e-commerce-smoky-eight-80.vercel.app/img/electronics-banner-2.jpg">
            <MenuItems description="Desktop"/>
            <MenuItems description="Laptop"/>
            <MenuItems description="Camera"/>
            <MenuItems description="Tablet"/>
